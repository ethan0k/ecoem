...
Partial Class WebApp_Tariffari_TariffarioD
    Inherits System.Web.UI.Page

    Private Sub WebApp_Tariffari_TariffarioD_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        SqlDatasource1.SelectParameters("Professionale").DefaultValue = 0
    ...
    Private Sub cmdEsporta_Click(sender As Object, e As EventArgs) Handles cmdEsporta.Click
        ...
        Using pck As New ExcelPackage()
            ...
            Dim ws As ExcelWorksheet = pck.Workbook.Worksheets.Add("Tariffario domestico")

            'Load the datatable into the sheet, starting from cell A1. Print the column names on row 1
            ws.Cells("A1").LoadFromDataTable(dt, True)

            Using rng As ExcelRange = ws.Cells("A1:g10")
                rng.AutoFitColumns()
            End Using

            'Write it back to the client
            Response.AddHeader("content-disposition", "attachment;  filename=TariffarioDomestico.xlsx")

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TariffarioD.aspx.vb" Inherits="WebApp_Tariffari_TariffarioD" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
    ...
    <h1>Tariffario categorie domestiche</h1>
    ...
    <asp:ListView ID="Listview1" runat="server" DataSourceID="SqlDatasource1" DataKeyNames="Id" >
        ...
        <asp:SqlDataSource runat="server" ID="SqlDatasource1" ConnectionString="<%$ ConnectionStrings:aspnet_staterKits_TimeTracker %>" 
            ...
            <SelectParameters>
                ...
                <asp:Parameter Name="Professionale" DefaultValue="0" />                
            </SelectParameters>
        </asp:SqlDataSource> 

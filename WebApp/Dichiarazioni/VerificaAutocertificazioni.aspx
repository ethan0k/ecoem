<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="VerificaAutocertificazioni.aspx.vb" Inherits="WebApp_Dichiarazioni_VerificaAutocertificazioni" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
      <h1>Verifica Autocertificazioni ECO-Contributi</h1>
    ...
    <div class="toolbar">
        <ul>
            ...
            <li class="button-profile-2">
             ...
             <li class="button-profile-2">
                <asp:LinkButton runat="server" ID="cmdInviaMail" CssClass="invia_button2"> <span class="ui-icon ui-ui-icon-arrowrefresh-1-n  toolbar-icon"></span><span class="desc">Invia Mail</span> </asp:LinkButton>
            </li>         
        </ul>
    </div>
        ...
        <div class="row-fluid">            
            <div class="span3" id="DivFiltroProduttore" runat="server">
                <div class="control-group">
                    ...
                    <asp:TextBox runat="server" ID="txtData" CssClass="medium" AutoComplete="off" Enabled="false"></asp:TextBox>
                </div>
            </div>  
        </div>
    </div>
    ...
    function pageLoad() {
        $(function () {
           ...
           $(".apri_button2").click(function () {
                     ...
                     jConfirm("Procedere con la generazione automatica delle dichiarazioni?",
                             'Conferma utente',
                             function (r) {
                                 if (r) {
            ...
            $(".invia_button2").click(function () {
                     var callFrom = $(this);

                     jConfirm("Procedere con l'invio automatico delle email?",
                             'Conferma utente',
                             function (r) {
                                 if (r) {
                                     __doPostBack(callFrom.attr('id').replace(/_/g, '$'), '');

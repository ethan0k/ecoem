...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
      <h1>Verifica dichiarazioni ECO-Contributi</h1>
    ...
    <div class="toolbar">
        <ul>
            ...
            <li class="button-profile-2">
                <asp:LinkButton runat="server" ID="cmdAutodichiarazione" CssClass="apri_button2"> <span class="ui-icon ui-icon-document toolbar-icon"></span><span class="desc">Autodichiarazioni</span> </asp:LinkButton>
            </li>         
        </ul>
    </div>

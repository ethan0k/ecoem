<%@ Page Title="Lista dichiarazioni" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ListaDichiarazioni.aspx.vb" Inherits="WebApp_Dichiarazioni_ListaDichiarazioni" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
    ...
    <h1>Lista dichiarazioni ECO-Contributi</h1>
            ...
            <div class="span3">
             ...
             <div class="span3">
                <div class="control-group">
                    ...
                    <asp:DropDownList runat="server" ID="ddlFatturata"  DataValueField="Id" DataTextField="Fatturata" AutoPostBack="true" AppendDataBoundItems="true" CssClass="chzn-select medium-select select" >
                        <asp:ListItem Text="Selezionare.." Value="-1"></asp:ListItem>                        
                        <asp:ListItem Text="Non fatturata" Value="0"></asp:ListItem>                        
                        <asp:ListItem Text="Fatturata" Value="1"></asp:ListItem>                        
                    </asp:DropDownList>
                </div>
            </div> 
        </div>       
        ...
        <div class="clear"></div>
            ...
            <asp:ListView ID="Listview1" runat="server" DataSourceID="SqlDatasource1" DataKeyNames="Id">
                        ...
                        <table class="display">
                            <thead>
                                <tr>
                                    ...
                                    <th class="info-th"><asp:LinkButton ID="LinkButton9" CommandName="Sort" CommandArgument="Confermata" runat="server" ><asp:Label runat="server" ID="Label7" Text="Confermata" ></asp:Label></asp:LinkButton></th>
                                    <th class="info-th"><asp:LinkButton ID="LinkButton6" CommandName="Sort" CommandArgument="Autostimata" runat="server" ><asp:Label runat="server" ID="Label11" Text="Autostimata" ></asp:Label></asp:LinkButton></th>
                                    <th class="title-th"><asp:LinkButton ID="LinkButton4" CommandName="Sort" CommandArgument="Eco Contributi" runat="server" ><asp:Label runat="server" ID="Label5" Text="Importo" ></asp:Label></asp:LinkButton></th>                                                                
                                    <th class="info-th" runat="server" id="colToHide"><asp:LinkButton ID="LinkButton5" CommandName="Sort" CommandArgument="Fatturata" runat="server" ><asp:Label runat="server" ID="Label10" Text="Fatturata"></asp:Label></asp:LinkButton></th>                                                                                                      
                ...
                <ItemTemplate>
                    <tr class="gray-tr">
                       ...
                       <td>
                        ...
                        <td runat="server" id="colAutostima">
                            <%#IIf(Eval("Autostimata"), "Sì", "No")%>
                        </td>
                         <td>
                            <asp:Label ID="lblImporto" runat="server" Text='<%# Eval("Importo", "{0:C}")%>' />
                        </td>
                         <td runat="server" id="colFatturata">
                            <%#IIf(Eval("Fatturata"), "Sì", "No")%>
                        </td>                         
                        <td>
                ...
                <AlternatingItemTemplate>
                    <tr>
                        <td>
                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("Data", "{0:dd/MM/yyyy}")%>' />
                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("Id")%>' Visible="false" />
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:Label ID="Label8" runat="server" Text='<%# Eval("DataRegistrazione", "{0:dd/MM/yyyy}")%>' />
                        </td>
                        <td>
                            <%#IIf(Eval("Confermata"), "Sì", "No")%>
                        </td>

...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
    ...
    <h1>Dettaglio dichiarazione ECO contributi <div style="color:red;display:inline"><asp:Literal runat="server" ID="titleConfermata" Text="Confermata" Visible="false"></asp:Literal> </div> </h1>
        ...
        <asp:UpdatePanel runat="server" ID="upd2">
            ...
            <ContentTemplate>
                <div class="row-fluid">
                    ...
                    <div class="span3">
                    <div class="control-group">
                        <label>Autostimata:</label>
                        <asp:Label runat="server" ID="lblAutostimata" Font-Bold="true"  CssClass="medium" text="No" ></asp:Label>                    
                    </div>
            </div>
                </div>
            </ContentTemplate>
                ...
                <table class="display">
                    <thead>
                        <tr>
                            ...
                            <th class="info-th"><asp:LinkButton ID="LinkButton3" CommandName="Sort" CommandArgument="Pezzi" runat="server" ><asp:Label runat="server" ID="Label3" Text="Pezzi" ></asp:Label></asp:LinkButton></th>
                            <th class="info-th"><asp:LinkButton ID="LinkButton6" CommandName="Sort" CommandArgument="Kg" runat="server" ><asp:Label runat="server" ID="Label6" Text="Kg" ></asp:Label></asp:LinkButton></th>
                            <th class="info-th"><asp:LinkButton ID="LinkButton5" CommandName="Sort" CommandArgument="CostoUnitario" runat="server" ><asp:Label runat="server" ID="Label7" Text="Costo unitario" ></asp:Label></asp:LinkButton></th>
                            <th class="info-th" style="padding-right:20px"><asp:LinkButton ID="LinkButton4" CommandName="Sort" CommandArgument="Importo" runat="server" ><asp:Label runat="server" ID="Label5" Text="ECO Contributi" ></asp:Label></asp:LinkButton></th>                            
                            <th class="info-th" style="width:fit-content" runat="server" id="colToHide" scope="col" ><asp:LinkButton ID="linkbutton" CommandName="Sort" CommandArgument="UtenteAggiornamento" runat="server" ><asp:Label runat="server" ID="Label11" Text="Utente agg." ></asp:Label></asp:LinkButton></th>                            
            ...
            <tr class="gray-tr">
               ...
               <td>
                ...
                <td runat="server" id="ColToHide2">
                    <asp:Label ID="Label11" runat="server"  Text='<%# Eval("DataAggiornamento", "{0:d}")%>' />
                </td>
            </tr>
        </ItemTemplate>
    ...
    <asp:SqlDataSource runat="server" ID="SqlDatasource1" ConnectionString="<%$ ConnectionStrings:aspnet_staterKits_TimeTracker %>" SelectCommand="sp_RigheDichiarazioni_Lista" SelectCommandType="StoredProcedure" >
        <SelectParameters>
            ...
            <asp:ControlParameter name="OldVersion" ControlID="txtOldDichiarazione" DbType="Int16" />
        </SelectParameters> 
    </asp:SqlDataSource>

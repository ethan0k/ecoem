<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Upload.aspx.vb" Inherits="WebApp_Pannelli_Upload" %>
    ...
    <div class="toolbar" style="display:none">
        <ul>
            <li class="button-profile-2">
                <asp:LinkButton runat="server" ID="cmdSalva" OnClientClick="showDiv();"> <span class="ui-icon ui-icon-document toolbar-icon"></span><span class="desc">Carica</span> </asp:LinkButton>
            </li>
            <li class="button-profile-2">
...
<h1 style="text-align:center">** FUNZIONALITA' IN MANUTENZIONE **</h1>
<div style="display:none">
    <div class="form form-horizontal">
        <div class="control-group">            
            <label class="control-label">Download Template:</label>
                <div class="controls" style="margin-top:7px">
                    <asp:HyperLink runat="server" ID="hlkTemplate" Text="Template_Excel" NavigateUrl="~/Template/Template.xlsx"></asp:HyperLink>
                </div>
        </div>
        ...
        <div class="control-group" runat="server" id="divProduttore">            
            ...
            <div class="controls">
                <asp:DropDownList runat="server" ID="ddlProduttore" CssClass="chzn-select medium-select select" AppendDataBoundItems="true" DataSourceID="SqlDataSource2" DataTextField="RagioneSociale" DataValueField="Id" AutoPostBack="true">
        ...
        <div class="control-group" runat="server" id="div1">            
            ...
            <div class="controls">
                <asp:DropDownList runat="server" ID="ddlTipologia" CssClass="chzn-select medium-select select" AppendDataBoundItems="true" DataSourceID="SqlTipologia" DataTextField="Descrizione" DataValueField="Id" AutoPostBack="true">
                    <asp:ListItem Text="Selezionare .." Value="0"></asp:ListItem>
                </asp:DropDownList>
                <asp:SqlDataSource runat="server" ID="SqlTipologia" ConnectionString="<%$ ConnectionStrings:aspnet_staterKits_TimeTracker %>" 
                    SelectCommand="SELECT DISTINCT tbl_TipologieCelle.[Id], [Descrizione] FROM tbl_TipologieCelle INNER JOIN [tbl_AbbinamentoTipologiaFascia] 
                        ON tbl_TipologieCelle.Id = [tbl_AbbinamentoTipologiaFascia].IdTipologia WHERE [tbl_AbbinamentoTipologiaFascia].IdProduttore = @IdProduttore ORDER BY [Descrizione]">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlProduttore" Name="IdProduttore" PropertyName="SelectedValue" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </div>
        </div>
        ...
        <div class="control-group" runat="server" id="div2">            
            ...
            <div class="controls">
                <asp:DropDownList runat="server" ID="ddlFasciaDiPeso" CssClass="chzn-select medium-select select" AppendDataBoundItems="true" DataSourceID="SqlFascia" DataTextField="Descrizione" DataValueField="Id">
                    <asp:ListItem Text="Selezionare .." Value="0"></asp:ListItem>
                </asp:DropDownList>
                <asp:SqlDataSource runat="server" ID="SqlFascia" ConnectionString="<%$ ConnectionStrings:aspnet_staterKits_TimeTracker %>" SelectCommand="SELECT DISTINCT tbl_FasceDiPeso.[Id], [Descrizione] FROM tbl_FasceDiPeso INNER JOIN [tbl_AbbinamentoTipologiaFascia] 
                        ON tbl_FasceDiPeso.Id = [tbl_AbbinamentoTipologiaFascia].IdFascia WHERE [tbl_AbbinamentoTipologiaFascia].IdProduttore = @IdProduttore and 
                        [tbl_AbbinamentoTipologiaFascia].IdTipologia = @IdTipologia ORDER BY [Descrizione]">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlProduttore" Name="IdProduttore" PropertyName="SelectedValue" />
                        <asp:ControlParameter ControlID="ddlTipologia" Name="IdTipologia" PropertyName="SelectedValue" />
                    </SelectParameters>
                </asp:SqlDataSource>
        ...
        <div class="control-group" id="divAnno" runat="server" visible="false">
         ...
         <div class="control-group" id="divProtocollo" runat="server" visible="false">
            <label class="control-label">Protocollo da assegnare:</label>
            <div class="controls">
                <div class="uploader black">
                    <asp:TextBox runat="server" ID="txtProtDaAssegnare" CssClass="filename"></asp:TextBox>
                </div>
            </div>
        </div>
    ...
    <asp:ListView ID="ListaErrori" runat="server" DataSourceID="SqlDatasource1" DataKeyNames="Id">
                ...
                <table class="display">
                    <thead>
                        <tr>
                            ...
                            <th class="info-th"><asp:LinkButton ID="LinkButton3" CommandName="Sort" CommandArgument="Modello" runat="server" ><asp:Label runat="server" ID="Label5" Text="Modello" ></asp:Label></asp:LinkButton></th>
                            <th class="info-th"><asp:LinkButton ID="LinkButton4" CommandName="Sort" CommandArgument="InErrore" runat="server" ><asp:Label runat="server" ID="Label7" Text="In errore" ></asp:Label></asp:LinkButton></th>
                            <th class="title-th"><asp:LinkButton ID="LinkButton2" CommandName="Sort" CommandArgument="Errore" runat="server" ><asp:Label runat="server" ID="Label2" Text="Descrizione errore" ></asp:Label></asp:LinkButton></th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <ItemTemplate>
            <tr class="gray-tr">
                ...
                <td>
                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("Modello")%>' />                    
                </td>
                <td>
                    <asp:Label ID="Label8" runat="server" Text='<%# If(Eval("InErrore").ToString() = "True", "Sì", "No") %>' ></asp:Label>
                </td>
                <td>
        ...
        <AlternatingItemTemplate>
            <tr>
                ...
                <td>
                    <%--<asp:Label ID="Label6" runat="server" Text='<%# Eval("InErrore")%>' />                    --%>
                    <asp:Label ID="Label8" runat="server" Text='<%# If(Eval("InErrore").ToString() = "True", "Sì", "No") %>' ></asp:Label>
                </td>
                <td>

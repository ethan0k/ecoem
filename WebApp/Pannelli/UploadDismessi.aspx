<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="UploadDismessi.aspx.vb" Inherits="WebApp_Pannelli_UploadDismessi" %>
...
$(document).ready(function () {
        ...
        <div class="control-group">            
            <label class="control-label">Download Template:</label>
                <div class="controls" style="margin-top:7px">
                    <asp:HyperLink runat="server" ID="hlkTemplate" Text="Template_Excel" NavigateUrl="~/Template/TemplateDismessi.xlsx"></asp:HyperLink>
                </div>
        </div>
                ...
                <table class="display">
                    <thead>
                        <tr>
                            ...
                            <th class="info-th"><asp:LinkButton ID="LinkButton3" CommandName="Sort" CommandArgument="DataRitiro" runat="server" ><asp:Label runat="server" ID="Label5" Text="Data ritiro" ></asp:Label></asp:LinkButton></th>
                            <th class="info-th"><asp:LinkButton ID="LinkButton5" CommandName="Sort" CommandArgument="NumeroFIR" runat="server" ><asp:Label runat="server" ID="Label9" Text="Numero FIR" ></asp:Label></asp:LinkButton></th>
        ...
        <ItemTemplate>
            <tr class="gray-tr">
                <td>
                 ...
                 <td>
                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("DataRitiro")%>' />                    
                </td>
                 <td>
                    <asp:Label ID="Label6" runat="server" Text='<%# Eval("NumeroFIR")%>' />                    
                </td>
                <td>
    ...
    <asp:SqlDataSource runat="server" ID="SqlDatasource1" ConnectionString="<%$ ConnectionStrings:aspnet_staterKits_TimeTracker %>" SelectCommand="sp_Errore_ListaDismessi" SelectCommandType="StoredProcedure">
       <SelectParameters>

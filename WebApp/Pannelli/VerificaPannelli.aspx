<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="VerificaPannelli.aspx.vb" Inherits="WebApp_Pannelli_VerificaPannelli" %>
...
$(document).ready(function () {
        ...
        <div class="control-group">            
            <label class="control-label">Download Template:</label>
                <div class="controls" style="margin-top:7px">
                    <asp:HyperLink runat="server" ID="hlkTemplate" Text="Template_Excel" NavigateUrl="~/Template/TemplateVerifica.xlsx"></asp:HyperLink>
                </div>
        </div>
        ...
        <ul>           
            ...
            <li class="button-profile-2">
                <div class="btn-group" role="group" aria-label="..." id="dvGroup" runat="server">
                    ...
                    <asp:Button ID="btErrori" runat="server" CssClass="btn btn-default" Text="In archivio" />
                </div>
            </li>            
        </ul>
    </div>
    ...
    <asp:ListView ID="ListaErrori" runat="server" DataSourceID="SqlDatasource1" DataKeyNames="Id">
                ...
                <table class="display">
                    <thead>
                        <tr>
                            ...
                            <th class="info-th"><asp:LinkButton ID="LinkButton5" CommandName="Sort" CommandArgument="Modello" runat="server" ><asp:Label runat="server" ID="Label6" Text="Conforme" ></asp:Label></asp:LinkButton></th>
                            <th class="info-th"><asp:LinkButton ID="LinkButton3" CommandName="Sort" CommandArgument="Protocollo" runat="server" ><asp:Label runat="server" ID="Label5" Text="Protocollo" ></asp:Label></asp:LinkButton></th>
                            <th class="info-th"><asp:LinkButton ID="LinkButton4" CommandName="Sort" CommandArgument="InErrore" runat="server" ><asp:Label runat="server" ID="Label7" Text="In archivio" ></asp:Label></asp:LinkButton></th>
                            <th class="info-th"><asp:LinkButton ID="LinkButton6" CommandName="Sort" CommandArgument="Impianto" runat="server" ><asp:Label runat="server" ID="Label10" Text="Impianto" ></asp:Label></asp:LinkButton></th>
                            <th class="info-th"><asp:LinkButton ID="LinkButton7" CommandName="Sort" CommandArgument="Stato" runat="server" ><asp:Label runat="server" ID="Label11" Text="Stato" ></asp:Label></asp:LinkButton></th>
                            <th class="title-th"><asp:LinkButton ID="LinkButton2" CommandName="Sort" CommandArgument="Note" runat="server" ><asp:Label runat="server" ID="Label2" Text="Errore" ></asp:Label></asp:LinkButton></th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <ItemTemplate>
            <tr class="gray-tr">
                ...
                <td>
                    <asp:Label ID="Label9" runat="server" Text='<%# Eval("Modello")%>' />                    
                </td>
                <td>
                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("Protocollo")%>' />                    
                </td>
                <td>
                    <asp:Label ID="Label8" runat="server" Text='<%# If(Eval("InErrore").ToString() = "True", "Sì", "No") %>' ></asp:Label>
                </td>
               <td>
                    <asp:Label ID="Label12" runat="server" Text='<%# Eval("Impianto")%>' />
                </td>
                <td>
                    <asp:Label ID="Label13" runat="server" Text='<%# Eval("Stato")%>' />
                </td>
                <td>
    ...
    <asp:SqlDataSource runat="server" ID="SqlDatasource1" ConnectionString="<%$ ConnectionStrings:aspnet_staterKits_TimeTracker %>" SelectCommand="sp_Errore_Verifica" SelectCommandType="StoredProcedure">
       <SelectParameters>

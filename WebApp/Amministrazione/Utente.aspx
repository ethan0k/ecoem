<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Utente.aspx.vb" Inherits="WebApp_Amministrazione_Utente" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
    ...
    <div class="form form-horizontal">
        ...
        <div class="control-group">            
            ...
            <div class="controls">
                <asp:TextBox CssClass="medium v-name" ID="txtUserName" runat="server" />
        ...
        <div class="control-group">            
         ...
         <div class="control-group" runat="server" id="divCliente" visible="false">            
            ...
            <div class="controls">
                <asp:DropDownList runat="server" ID="ddlClienti" CssClass="chzn-select medium-select select" AppendDataBoundItems="true" DataSourceID="SqlClienti" DataTextField="Nominativo" DataValueField="IdCliente">
                    <asp:ListItem Text="Selezionare .." Value="0"></asp:ListItem>
                </asp:DropDownList>
                <asp:SqlDataSource runat="server" ID="sqlClienti" ConnectionString="<%$ ConnectionStrings:aspnet_staterKits_TimeTracker %>" SelectCommand="SELECT [IdCliente], [RagioneSociale] + [Cognome] + ' ' + [Nome] AS Nominativo FROM [tbl_Clienti] ORDER BY [RagioneSociale]"></asp:SqlDataSource>
            </div>
        </div>
        <div class="control-group" runat="server" id="divProduttore" visible="false">            
            <label class="control-label">Produttore:</label>
            <div class="controls">
                <asp:DropDownList runat="server" ID="ddlProduttori" CssClass="chzn-select medium-select select" AppendDataBoundItems="true" DataSourceID="sqlProduttori" DataTextField="RagioneSociale" DataValueField="Id">
                    <asp:ListItem Text="Selezionare .." Value="0"></asp:ListItem>
                </asp:DropDownList>
        ...
        <div class="control-group">            
            <label class="control-label">Approvato:</label>
            <div class="controls">
                <asp:checkbox runat="server" id="chkApprovato" CssClass="styled"/>
            </div>
        </div>
        <div class="control-group">            
            <label class="control-label">Bloccato:</label>
            <div class="controls">
                <asp:checkbox runat="server" id="chkBloccato" CssClass="styled"/>
            </div>
        </div>

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ListaFasce.aspx.vb" Inherits="WebApp_Amministrazione_ListaFasce" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
    <h1>Lista fasce di peso</h1>
            ...
            <LayoutTemplate>
                <div id="itemPlaceholderContainer" runat="server">
                    <table class="display">
                        <thead>
                            <tr>                            
                                <th class="title-th"><asp:LinkButton ID="LinkButton2" CommandName="Sort" CommandArgument="Descrizione" runat="server" ><asp:Label runat="server" ID="Label2" Text="Descrizione" ></asp:Label></asp:LinkButton></th>
        ...
        <asp:SqlDataSource runat="server" ID="SqlDatasource1" ConnectionString="<%$ ConnectionStrings:aspnet_staterKits_TimeTracker %>" SelectCommand="sp_FasciaDiPeso_Lista" SelectCommandType="StoredProcedure">
            <SelectParameters>

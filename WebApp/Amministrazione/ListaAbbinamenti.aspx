<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ListaAbbinamenti.aspx.vb" Inherits="WebApp_Amministrazione_ListaAbbinamenti" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
    ...
    <h1><asp:Literal runat="server" ID="Titolo" Text="Abbinamenti Tipologie celle / fasce di peso per il cliente .."></asp:Literal></h1>  
        ...
        <asp:ListView ID="Listview1" runat="server" DataSourceID="SqlDatasource1" DataKeyNames="Id">
            ...
            <ItemTemplate>
                <tr class="gray-tr">                
                    ...
                    <td>
                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("CostoMatricola") %>' />
                    </td>
                    <td>
                        <ul class="button-table-head">
                            ...
                            <li>
                                <div class="delete-icon">
                                    <asp:LinkButton ID="DeleteButton" OnClientClick="return confirm('Cancellare il record?');" runat="server" CssClass="deleteButton" CommandName="Elimina" CommandArgument='<%#Eval("ID")%>'>
                                <span>Delete</span>
                                    </asp:LinkButton>
                                </div>
                            </li>

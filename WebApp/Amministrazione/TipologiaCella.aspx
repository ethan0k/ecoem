<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TipologiaCella.aspx.vb" Inherits="WebApp_Amministrazione_TipologiaCella" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" Runat="Server">
    ...
    <h1>Informazioni tipologia cella</h1>
    ...
    <div class="form form-horizontal">        
        ...
        <div class="control-group">            
            ...
            <div class="controls">
                <asp:TextBox CssClass="medium v-name" ID="txtDescrizioneTipologia" runat="server" />
            </div>
        </div>         

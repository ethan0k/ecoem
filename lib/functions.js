                ...
                if ($(parent).hasClass('noaccordion')) {
                    ...
                    if (theElement.hasClass('acitem') && theElement.is(':visible')) {
                        if ($(parent).hasClass('collapsible')) {
                            ...
                            $('.acitem:visible > li > .acitem:visible', parent).slideUp('normal', function () {
                                $(this).prev().removeClass('active');
                            });
                            return false;
                        }
...
$(document).ready(function () {
    ...
    $("input[type=file]").each(function () {
        if ($(this).val() == "") { $(this).parents(".uploader").find(".filename").val("Nessun file selezionato..."); }
    });
});
...
//        $(".toolbar").each(function (idx, val) { $(val).width($(val).parent().width() - 10); });
//    } else {

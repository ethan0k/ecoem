...
Namespace ASPNET.StarterKit.BusinessLogicLayer
    Public Class RigaDichiarazioneRaggruppate
        ...
        Public Shared Function Lista(ByVal IdDichiarazione As Integer) As List(Of RigaDichiarazioneRaggruppate)

            Return DataAccessHelper.GetDataAccess().ListaRigheDicRaggruppate(IdDichiarazione)
